...
<%--                <div class="reg">--%>
<%--                    <c:if test="${userLogin!=null}">--%>
<%--                        <p class="mb-0">${userLogin.userName}--%>
...
<%--                                <a href="<%=request.getContextPath()%>/showOrderController/orderUser">Orders</a>--%>
<%--                            </div>--%>
<%--                            <div class="dropdown-item d-flex align-items-start" href="#">--%>
<%--                                <a href="<%=request.getContextPath()%>/userController/logout">Log Out</a>--%>
<%--                            </div>--%>
